--------------------------------------------------------
-- Archivo creado  - lunes-octubre-27-2025   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table ASISTENCIA_EMPLEADO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ASISTENCIA_EMPLEADO" 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table EMPLEADO_CAPACITACION
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."EMPLEADO_CAPACITACION" 
   (	"EMPLEADO_ID" NUMBER(6,0), 
	"COD_CAPACITACION" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table EMPLEADO_HORARIO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."EMPLEADO_HORARIO" 
   (	"DIA_SEMANA" VARCHAR2(10 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."J" 
   (	"J#" VARCHAR2(2 BYTE), 
	"JNAME" VARCHAR2(50 BYTE), 
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ASISTENCIA_EMPLEADO
SET DEFINE OFF;
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('101','MONDAY',to_date('20/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('101','MONDAY',to_date('20/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('102','TUESDAY',to_date('21/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('102','TUESDAY',to_date('21/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('103','WEDNESDAY',to_date('22/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('103','WEDNESDAY',to_date('22/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('104','THURSDAY',to_date('23/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('104','THURSDAY',to_date('23/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('105','FRIDAY',to_date('24/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('105','FRIDAY',to_date('24/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('101','MONDAY',to_date('20/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.ASISTENCIA_EMPLEADO (EMPLEADO_ID,DIA_SEMANA,FECHA,HORA_INICIO_REAL,HORA_TERMINO_REAL) values ('101','MONDAY',to_date('20/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
REM INSERTING into SYSTEM.CAPACITACION
SET DEFINE OFF;
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('1','Seguridad Informática','8','Curso sobre ciberseguridad básica');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('2','Gestión de Proyectos','10','Taller de metodologías ágiles');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('3','Excel Avanzado','6','Curso práctico de hojas de cálculo');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('4','Comunicación Efectiva','4','Seminario de habilidades blandas');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('5','Bases de Datos Oracle','12','Capacitación técnica en SQL y PL/SQL');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('6','Inteligencia Artificial','10','Introducción a modelos de ML');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('7','Docker y DevOps','8','Contenedores y automatización');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('8','Finanzas Personales','5','Educación financiera básica');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('9','Marketing Digital','7','Estrategias de redes sociales');
Insert into SYSTEM.CAPACITACION (COD_CAPACITACION,NOMBRE,HORAS,DESCRIPCION) values ('10','Diseño UX/UI','9','Principios de diseño centrado en el usuario');
REM INSERTING into SYSTEM.COUNTRIES
SET DEFINE OFF;
Insert into SYSTEM.COUNTRIES (COUNTRY_ID,COUNTRY_NAME,REGION_ID) values ('FR','France','1');
Insert into SYSTEM.COUNTRIES (COUNTRY_ID,COUNTRY_NAME,REGION_ID) values ('US','United States','2');
...
SET DEFINE OFF;
Insert into SYSTEM.DEPARTMENTS (DEPARTMENT_ID,DEPARTMENT_NAME,MANAGER_ID,LOCATION_ID) values ('10','Sales',null,'1001');
Insert into SYSTEM.DEPARTMENTS (DEPARTMENT_ID,DEPARTMENT_NAME,MANAGER_ID,LOCATION_ID) values ('20','Marketing',null,'1002');
Insert into SYSTEM.DEPARTMENTS (DEPARTMENT_ID,DEPARTMENT_NAME,MANAGER_ID,LOCATION_ID) values ('30','IT',null,'1000');
Insert into SYSTEM.DEPARTMENTS (DEPARTMENT_ID,DEPARTMENT_NAME,MANAGER_ID,LOCATION_ID) values ('40','HR',null,'1003');
Insert into SYSTEM.DEPARTMENTS (DEPARTMENT_ID,DEPARTMENT_NAME,MANAGER_ID,LOCATION_ID) values ('50','Finance',null,'1004');
REM INSERTING into SYSTEM.EMPLEADO_CAPACITACION
SET DEFINE OFF;
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('101','1');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('101','3');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('102','2');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('102','4');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('103','5');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('103','6');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('104','7');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('104','8');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('105','9');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('105','10');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('106','1');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('106','2');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('107','3');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('108','4');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('109','5');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('110','6');
Insert into SYSTEM.EMPLEADO_CAPACITACION (EMPLEADO_ID,COD_CAPACITACION) values ('110','7');
REM INSERTING into SYSTEM.EMPLEADO_HORARIO
SET DEFINE OFF;
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('MONDAY','Mañana','101');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('MONDAY','Tarde','101');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('TUESDAY','Mañana','102');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('TUESDAY','Tarde','102');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('WEDNESDAY','Mañana','103');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('WEDNESDAY','Tarde','103');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('THURSDAY','Mañana','104');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('THURSDAY','Tarde','104');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('FRIDAY','Mañana','105');
Insert into SYSTEM.EMPLEADO_HORARIO (DIA_SEMANA,TURNO,EMPLEADO_ID) values ('FRIDAY','Tarde','105');
REM INSERTING into SYSTEM.EMPLOYEES
SET DEFINE OFF;
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('101','Alice','Smith','asmith@example.com','555-1234',to_date('15/01/18','DD/MM/RR'),'SA_REP','5000',null,null,'10');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('102','Bob','Jones','bjones@example.com','555-2345',to_date('10/03/19','DD/MM/RR'),'MK_MAN','6000',null,null,'20');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('103','Carlos','Tanaka','ctanaka@example.com','555-3456',to_date('01/06/20','DD/MM/RR'),'IT_PROG','5500',null,null,'30');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('104','Diana','Silva','dsilva@example.com','555-4567',to_date('20/09/21','DD/MM/RR'),'HR_ASS','3000',null,null,'40');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('105','Ethan','Khan','ekhan@example.com','555-5678',to_date('05/11/22','DD/MM/RR'),'FI_ANAL','7000',null,null,'50');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('106','Fiona','Lee','flee@example.com','555-6789',to_date('12/05/17','DD/MM/RR'),'SA_REP','5200',null,null,'10');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('107','George','Miller','gmiller@example.com','555-7890',to_date('25/08/16','DD/MM/RR'),'MK_MAN','6200',null,null,'20');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('108','Hana','Yamamoto','hyamamoto@example.com','555-8901',to_date('30/12/15','DD/MM/RR'),'IT_PROG','5800',null,null,'30');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('109','Ivan','Petrov','ipetrov@example.com','555-9012',to_date('18/04/14','DD/MM/RR'),'HR_ASS','3100',null,null,'40');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('110','Julia','Martinez','jmartinez@example.com','555-0123',to_date('07/07/13','DD/MM/RR'),'FI_ANAL','7300',null,null,'50');
...
REM INSERTING into SYSTEM.HORARIO
SET DEFINE OFF;
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('MONDAY','Mañana',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('MONDAY','Tarde',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('TUESDAY','Mañana',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('TUESDAY','Tarde',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('WEDNESDAY','Mañana',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('WEDNESDAY','Tarde',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('THURSDAY','Mañana',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('THURSDAY','Tarde',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('FRIDAY','Mañana',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
Insert into SYSTEM.HORARIO (DIA_SEMANA,TURNO,HORA_INICIO,HORA_TERMINO) values ('FRIDAY','Tarde',to_date('01/10/25','DD/MM/RR'),to_date('01/10/25','DD/MM/RR'));
REM INSERTING into SYSTEM.J
SET DEFINE OFF;
Insert into SYSTEM.J (J#,JNAME,CITY) values ('J1','Sorter','Paris');
Insert into SYSTEM.J (J#,JNAME,CITY) values ('J2','Display','Rome');
Insert into SYSTEM.J (J#,JNAME,CITY) values ('J3','OCR','Athens');
Insert into SYSTEM.J (J#,JNAME,CITY) values ('J4','Console','Athens');
Insert into SYSTEM.J (J#,JNAME,CITY) values ('J5','RAID','London');
Insert into SYSTEM.J (J#,JNAME,CITY) values ('J6','EDS','Oslo');
Insert into SYSTEM.J (J#,JNAME,CITY) values ('J7','Tape','London');
REM INSERTING into SYSTEM.JOB_HISTORY
SET DEFINE OFF;
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('101',to_date('15/01/18','DD/MM/RR'),to_date('15/01/19','DD/MM/RR'),'SA_REP','10');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('101',to_date('16/01/19','DD/MM/RR'),to_date('15/01/20','DD/MM/RR'),'MK_MAN','20');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('102',to_date('10/03/19','DD/MM/RR'),to_date('10/03/20','DD/MM/RR'),'MK_MAN','20');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('103',to_date('01/06/20','DD/MM/RR'),to_date('01/06/21','DD/MM/RR'),'IT_PROG','30');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('106',to_date('12/05/17','DD/MM/RR'),to_date('12/05/18','DD/MM/RR'),'SA_REP','10');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('106',to_date('13/05/18','DD/MM/RR'),to_date('12/05/19','DD/MM/RR'),'MK_MAN','20');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('106',to_date('13/05/19','DD/MM/RR'),to_date('12/05/20','DD/MM/RR'),'HR_ASS','40');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('107',to_date('25/08/16','DD/MM/RR'),to_date('25/08/17','DD/MM/RR'),'MK_MAN','20');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('107',to_date('26/08/17','DD/MM/RR'),to_date('25/08/18','DD/MM/RR'),'FI_ANAL','50');
Insert into SYSTEM.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('107',to_date('26/08/18','DD/MM/RR'),to_date('25/08/19','DD/MM/RR'),'SA_REP','10');
REM INSERTING into SYSTEM.JOBS
SET DEFINE OFF;
Insert into SYSTEM.JOBS (JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY) values ('SA_REP','Sales Representative','3000','7000');
Insert into SYSTEM.JOBS (JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY) values ('MK_MAN','Marketing Manager','4000','9000');
Insert into SYSTEM.JOBS (JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY) values ('IT_PROG','Programmer','3500','8000');
Insert into SYSTEM.JOBS (JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY) values ('HR_ASS','HR Assistant','2500','6000');
Insert into SYSTEM.JOBS (JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY) values ('FI_ANAL','Financial Analyst','4500','9500');
REM INSERTING into SYSTEM.LOCATIONS
SET DEFINE OFF;
Insert into SYSTEM.LOCATIONS (LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID) values ('1000','Champs Elysees','75008','Paris','Ile-de-France','FR');
Insert into SYSTEM.LOCATIONS (LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID) values ('1001','5th Avenue','10001','New York','NY','US');
Insert into SYSTEM.LOCATIONS (LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID) values ('1002','Shibuya','150-0002','Tokyo','Tokyo','JP');
Insert into SYSTEM.LOCATIONS (LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID) values ('1003','Paulista','01310-000','São Paulo','SP','BR');
Insert into SYSTEM.LOCATIONS (LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID) values ('1004','Zamalek','11211','Cairo','Cairo','EG');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.P
SET DEFINE OFF;
Insert into SYSTEM.P (P#,PNAME,COLOR,WEIGHT,CITY) values ('P1','Nut','Red','12','London');
Insert into SYSTEM.P (P#,PNAME,COLOR,WEIGHT,CITY) values ('P2','Bolt','Green','17','Paris');
Insert into SYSTEM.P (P#,PNAME,COLOR,WEIGHT,CITY) values ('P3','Screw','Blue','17','Rome');
Insert into SYSTEM.P (P#,PNAME,COLOR,WEIGHT,CITY) values ('P4','Screw','Red','14','London');
Insert into SYSTEM.P (P#,PNAME,COLOR,WEIGHT,CITY) values ('P5','Cam','Blue','12','Paris');
Insert into SYSTEM.P (P#,PNAME,COLOR,WEIGHT,CITY) values ('P6','Cog','Red','19','London');
...
Insert into SYSTEM.REGIONS (REGION_ID,REGION_NAME) values ('4','Africa');
REM INSERTING into SYSTEM.S
SET DEFINE OFF;
Insert into SYSTEM.S (S#,SNAME,STATUS,CITY) values ('S1','Smith','20','London');
Insert into SYSTEM.S (S#,SNAME,STATUS,CITY) values ('S2','Jones','10','Paris');
Insert into SYSTEM.S (S#,SNAME,STATUS,CITY) values ('S3','Blake','30','Paris');
Insert into SYSTEM.S (S#,SNAME,STATUS,CITY) values ('S4','Clark','20','London');
Insert into SYSTEM.S (S#,SNAME,STATUS,CITY) values ('S5','Adams','30','Athens');
REM INSERTING into SYSTEM.SCHEDULER_JOB_ARGS_TBL
SET DEFINE OFF;
REM INSERTING into SYSTEM.SCHEDULER_PROGRAM_ARGS_TBL
SET DEFINE OFF;
REM INSERTING into SYSTEM.SP
SET DEFINE OFF;
Insert into SYSTEM.SP (S#,P#,QTY) values ('S1','P1','300');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S1','P2','200');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S1','P3','400');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S1','P4','200');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S1','P5','100');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S1','P6','100');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S2','P1','300');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S2','P2','400');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S3','P2','200');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S4','P2','200');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S4','P4','300');
Insert into SYSTEM.SP (S#,P#,QTY) values ('S4','P5','400');
REM INSERTING into SYSTEM.SPJ
SET DEFINE OFF;
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S1','P1','J1','200');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S1','P1','J4','700');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S2','P3','J1','400');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S2','P3','J2','200');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S2','P3','J3','200');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S2','P3','J4','500');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S2','P3','J5','600');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S2','P3','J6','400');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S2','P3','J7','800');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S2','P5','J2','100');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S3','P3','J1','200');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S3','P4','J2','500');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S4','P6','J3','300');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S4','P6','J7','300');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P2','J2','200');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P2','J4','100');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P5','J5','500');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P5','J7','100');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P6','J2','200');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P1','J4','100');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P3','J4','200');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P4','J4','800');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P5','J4','400');
Insert into SYSTEM.SPJ (S#,P#,J#,QTY) values ('S5','P6','J4','500');
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_JOB_HISTORY
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_JOB_HISTORY" ON "SYSTEM"."JOB_HISTORY" ("EMPLOYEE_ID", "START_DATE") 
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Trigger VALIDAR_ASISTENCIA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."VALIDAR_ASISTENCIA" 
...
BEGIN
  -- Validar que el día de la fecha coincida con el campo dia_semana
  v_dia := TO_CHAR(:NEW.fecha, 'DY', 'NLS_DATE_LANGUAGE=ENGLISH');
  IF TRIM(UPPER(v_dia)) != TRIM(UPPER(SUBSTR(:NEW.dia_semana, 1, 3))) THEN
    RAISE_APPLICATION_ERROR(-20001, 'La fecha no corresponde al día de la semana declarada.');
  END IF;

  -- Validar que exista al menos una coincidencia de horario asignado
  FOR r IN (
    SELECT h.hora_inicio, h.hora_termino
    FROM empleado_horario eh
    JOIN horario h ON eh.dia_semana = h.dia_semana AND eh.turno = h.turno
    WHERE eh.empleado_id = :NEW.empleado_id AND eh.dia_semana = :NEW.dia_semana
  ) LOOP
    IF :NEW.hora_inicio_real = r.hora_inicio AND :NEW.hora_termino_real = r.hora_termino THEN
      v_valido := TRUE;
      EXIT;
    END IF;
  END LOOP;
  ...
  IF NOT v_valido THEN
    RAISE_APPLICATION_ERROR(-20002, 'Las horas reales no coinciden con ningún horario asignado.');
  END IF;
END;

/
ALTER TRIGGER "SYSTEM"."VALIDAR_ASISTENCIA" ENABLE;
--------------------------------------------------------
--  DDL for Trigger VALIDAR_RANGO_SALARIAL
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."VALIDAR_RANGO_SALARIAL" 
...
BEGIN
  ...
  IF :NEW.salary < v_min OR :NEW.salary > v_max THEN
    RAISE_APPLICATION_ERROR(-20003, 'El salario está fuera del rango permitido para el puesto.');
  END IF;
END;

/
ALTER TRIGGER "SYSTEM"."VALIDAR_RANGO_SALARIAL" ENABLE;
--------------------------------------------------------
--  DDL for Procedure DETALLE_PROVEEDORES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DETALLE_PROVEEDORES" IS
BEGIN
  FOR r IN (SELECT * FROM S) LOOP
    DBMS_OUTPUT.PUT_LINE('S#: ' || r.S# || ', Nombre: ' || r.SNAME || ', Estado: ' || r.STATUS || ', Ciudad: ' || r.CITY);
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure EMPLEADOS_MAS_ROTACIONES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."EMPLEADOS_MAS_ROTACIONES" IS
BEGIN
  FOR r IN (
    ...
    DBMS_OUTPUT.PUT_LINE(r.employee_id || ' - ' || r.last_name || ', ' || r.first_name || ' - ' || r.job_id || ' - ' || r.job_title || ' - Cambios: ' || r.cambios);
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure MIN_MAX_P2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."MIN_MAX_P2" IS
  v_min NUMBER;
  v_max NUMBER;
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure PARES_CIUDADES_ABASTECIMIENTO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PARES_CIUDADES_ABASTECIMIENTO" IS
BEGIN
  FOR r IN (
    ...
    DBMS_OUTPUT.PUT_LINE('Proveedor en: ' || r.CIUDAD_PROVEEDOR || ' → Parte en: ' || r.CIUDAD_PARTE);
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure PARTES_FUERA_PARIS_PESO_ALTO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PARTES_FUERA_PARIS_PESO_ALTO" IS
BEGIN
  FOR r IN (
    SELECT COLOR, CITY
    FROM P
...
/
--------------------------------------------------------
--  DDL for Procedure PARTES_MULTI_PROVEEDOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PARTES_MULTI_PROVEEDOR" IS
BEGIN
  FOR r IN (
    SELECT P#
    FROM SP
    ...
    DBMS_OUTPUT.PUT_LINE('Parte abastecida por múltiples proveedores: ' || r.P#);
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure PARTES_PESO_O_S2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PARTES_PESO_O_S2" IS
BEGIN
  FOR r IN (
    SELECT DISTINCT P.P#
    FROM P
...
/
--------------------------------------------------------
--  DDL for Procedure PROVEEDORES_ACTIVOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROVEEDORES_ACTIVOS" IS
BEGIN
  FOR r IN (
...
/
--------------------------------------------------------
--  DDL for Procedure PROVEEDORES_COLOCALIZADOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROVEEDORES_COLOCALIZADOS" IS
BEGIN
  FOR r IN (
...
/
--------------------------------------------------------
--  DDL for Procedure PROVEEDORES_ESTADO_MENOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROVEEDORES_ESTADO_MENOR" IS
  v_max_status NUMBER;
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure PROVEEDORES_EXIST_P2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROVEEDORES_EXIST_P2" IS
BEGIN
  FOR r IN (
    SELECT SNAME
    FROM S
    ...
    DBMS_OUTPUT.PUT_LINE('Proveedor que abastece P2 (EXISTS): ' || r.SNAME);
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure PROVEEDORES_PARA_P2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROVEEDORES_PARA_P2" IS
BEGIN
  FOR r IN (
    SELECT DISTINCT S.SNAME
    FROM S
...
/
--------------------------------------------------------
--  DDL for Procedure PROVEEDORES_PARTES_COLOCALIZADOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROVEEDORES_PARTES_COLOCALIZADOS" IS
BEGIN
  FOR r IN (
    SELECT S.S#, P.P#
...
/
--------------------------------------------------------
--  DDL for Procedure PROVEEDORES_SIN_P2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROVEEDORES_SIN_P2" IS
BEGIN
  FOR r IN (
    SELECT SNAME
    FROM S
    ...
    DBMS_OUTPUT.PUT_LINE('Proveedor que NO abastece P2: ' || r.SNAME);
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure PROVEEDORES_TODAS_PARTES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROVEEDORES_TODAS_PARTES" IS
BEGIN
  FOR r IN (
    SELECT S.SNAME
    FROM S
...
/
--------------------------------------------------------
--  DDL for Procedure REPORTE_CAPACITACIONES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."REPORTE_CAPACITACIONES" IS
BEGIN
  FOR r IN (
    SELECT c.nombre AS nombre_capacitacion,
    ...
    JOIN employees e ON ec.empleado_id = e.employee_id
    GROUP BY c.nombre, e.first_name, e.last_name
    ORDER BY total_horas DESC
  ) LOOP
    DBMS_OUTPUT.PUT_LINE('Capacitación: ' || r.nombre_capacitacion || ' | Empleado: ' || r.empleado || ' | Horas: ' || r.total_horas);
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure REPORTE_SUELDO_MES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."REPORTE_SUELDO_MES" (p_mes NUMBER, p_anio NUMBER) IS
...
BEGIN
  FOR r IN (
    ...
    v_salario_base := r.salary;
    v_horas_trabajadas := horas_laboradas(r.employee_id, p_mes, p_anio);
    v_horas_faltantes := horas_faltantes(r.employee_id, p_mes, p_anio);

    DBMS_OUTPUT.PUT_LINE(r.first_name || ' ' || r.last_name || ' | Sueldo ajustado: ' ||
      ROUND(v_salario_base * (v_horas_trabajadas / (v_horas_trabajadas + v_horas_faltantes)), 2));
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure RESUMEN_REGIONAL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."RESUMEN_REGIONAL" IS
BEGIN
  FOR r IN (
    SELECT rg.region_name,
           SUM(e.salary) AS total_salarios,
           COUNT(e.employee_id) AS total_empleados,
           MIN(e.hire_date) AS fecha_antigua
    FROM employees e
    ...
    DBMS_OUTPUT.PUT_LINE('Región: ' || r.region_name || ' | Total salarios: ' || r.total_salarios || ' | Empleados: ' || r.total_empleados || ' | Antiguo: ' || TO_CHAR(r.fecha_antigua, 'DD-MM-YYYY'));
  END LOOP;
END;

/
--------------------------------------------------------
--  DDL for Procedure TOTAL_DESPACHADO_POR_PARTE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."TOTAL_DESPACHADO_POR_PARTE" IS
BEGIN
  FOR r IN (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."EMPLOYEE_PKG" AS
  PROCEDURE crear_empleado(p_id NUMBER, p_fname VARCHAR2, p_lname VARCHAR2, p_email VARCHAR2, p_hire DATE, p_job VARCHAR2, p_sal NUMBER);
  PROCEDURE leer_empleado(p_id NUMBER);
  PROCEDURE actualizar_salario(p_id NUMBER, p_salario NUMBER);
  PROCEDURE eliminar_empleado(p_id NUMBER);
END employee_pkg;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."EMPLOYEE_PKG" AS
  PROCEDURE crear_empleado(p_id NUMBER, p_fname VARCHAR2, p_lname VARCHAR2, p_email VARCHAR2, p_hire DATE, p_job VARCHAR2, p_sal NUMBER) IS
  BEGIN
    INSERT INTO employees (employee_id, first_name, last_name, email, hire_date, job_id, salary)
    VALUES (p_id, p_fname, p_lname, p_email, p_hire, p_job, p_sal);
  END;

  PROCEDURE leer_empleado(p_id NUMBER) IS
  ...
  PROCEDURE actualizar_salario(p_id NUMBER, p_salario NUMBER) IS
  BEGIN
    UPDATE employees SET salary = p_salario WHERE employee_id = p_id;
  END;

  PROCEDURE eliminar_empleado(p_id NUMBER) IS
  BEGIN
...
/
--------------------------------------------------------
--  DDL for Function CALCULAR_VACACIONES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."CALCULAR_VACACIONES" RETURN NUMBER IS
  v_total_monto NUMBER := 0;
BEGIN
  FOR r IN (
    SELECT employee_id, first_name, last_name,
           MONTHS_BETWEEN(SYSDATE, hire_date)/12 AS anios,
           ROUND(MONTHS_BETWEEN(SYSDATE, hire_date)/12) AS meses_vacaciones
    FROM employees
  ) LOOP
    DBMS_OUTPUT.PUT_LINE(r.employee_id || ' - ' || r.first_name || ' ' || r.last_name || ' | Años: ' || ROUND(r.anios,2) || ' | Vacaciones: ' || r.meses_vacaciones || ' meses');
    v_total_monto := v_total_monto + r.meses_vacaciones;
  END LOOP;
...
/
--------------------------------------------------------
--  DDL for Function HORAS_CAPACITACION_EMPLEADO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."HORAS_CAPACITACION_EMPLEADO" RETURN NUMBER IS
...
BEGIN
  FOR r IN (
    ...
    JOIN capacitacion c ON ec.cod_capacitacion = c.cod_capacitacion
    JOIN employees e ON ec.empleado_id = e.employee_id
    GROUP BY ec.empleado_id, e.first_name, e.last_name
  ) LOOP
    DBMS_OUTPUT.PUT_LINE(r.nombre || ' | Total horas: ' || r.total_horas);
...
/
--------------------------------------------------------
--  DDL for Function HORAS_FALTANTES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."HORAS_FALTANTES" (p_emp_id NUMBER, p_mes NUMBER, p_anio NUMBER) RETURN NUMBER IS
  v_horas_teoricas NUMBER := 0;
  v_horas_real NUMBER := 0;
BEGIN
  SELECT SUM((h.hora_termino - h.hora_inicio) * 24)
  INTO v_horas_teoricas
  FROM empleado_horario eh
  JOIN horario h ON eh.dia_semana = h.dia_semana AND eh.turno = h.turno
  WHERE eh.empleado_id = p_emp_id;

  v_horas_real := horas_laboradas(p_emp_id, p_mes, p_anio);

  RETURN GREATEST(v_horas_teoricas - v_horas_real, 0);
END;

/
--------------------------------------------------------
--  DDL for Function HORAS_LABORADAS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."HORAS_LABORADAS" (p_emp_id NUMBER, p_mes NUMBER, p_anio NUMBER) RETURN NUMBER IS
  v_horas NUMBER := 0;
BEGIN
  SELECT SUM(
...
/
--------------------------------------------------------
--  DDL for Function PESO_EN_GRAMOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."PESO_EN_GRAMOS" (p_numero VARCHAR2) RETURN NUMBER IS
  v_peso_libras NUMBER;
BEGIN
  SELECT WEIGHT INTO v_peso_libras FROM P WHERE P# = p_numero;
  RETURN v_peso_libras * 453.592;
END;

/
--------------------------------------------------------
--  DDL for Function PROMEDIO_CONTRATACIONES_MES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."PROMEDIO_CONTRATACIONES_MES" RETURN NUMBER IS
  v_total NUMBER := 0;
BEGIN
  FOR r IN (
...
/
--------------------------------------------------------
--  DDL for Function TOTAL_PROVEEDORES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."TOTAL_PROVEEDORES" RETURN NUMBER IS
  v_total NUMBER;
BEGIN
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."J" ADD PRIMARY KEY ("J#")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."EMPLOYEES" ADD UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SP" ADD PRIMARY KEY ("S#", "P#")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."P" ADD PRIMARY KEY ("P#")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOCATIONS" ADD PRIMARY KEY ("LOCATION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."JOB_HISTORY" ADD CONSTRAINT "PK_JOB_HISTORY" PRIMARY KEY ("EMPLOYEE_ID", "START_DATE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CAPACITACION" ADD PRIMARY KEY ("COD_CAPACITACION")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."S" ADD PRIMARY KEY ("S#")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SPJ" ADD PRIMARY KEY ("S#", "P#", "J#")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ASISTENCIA_EMPLEADO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ASISTENCIA_EMPLEADO" ADD CONSTRAINT "FK_AE_EMPLEADO" FOREIGN KEY ("EMPLEADO_ID")
	  REFERENCES "SYSTEM"."EMPLOYEES" ("EMPLOYEE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table COUNTRIES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."COUNTRIES" ADD CONSTRAINT "FK_REGION" FOREIGN KEY ("REGION_ID")
	  REFERENCES "SYSTEM"."REGIONS" ("REGION_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DEPARTMENTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DEPARTMENTS" ADD CONSTRAINT "FK_LOCATION" FOREIGN KEY ("LOCATION_ID")
	  REFERENCES "SYSTEM"."LOCATIONS" ("LOCATION_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMPLEADO_CAPACITACION
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."EMPLEADO_CAPACITACION" ADD CONSTRAINT "FK_EC_EMPLEADO" FOREIGN KEY ("EMPLEADO_ID")
	  REFERENCES "SYSTEM"."EMPLOYEES" ("EMPLOYEE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."EMPLEADO_CAPACITACION" ADD CONSTRAINT "FK_EC_CAPACITACION" FOREIGN KEY ("COD_CAPACITACION")
	  REFERENCES "SYSTEM"."CAPACITACION" ("COD_CAPACITACION") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMPLEADO_HORARIO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."EMPLEADO_HORARIO" ADD CONSTRAINT "FK_EH_EMPLEADO" FOREIGN KEY ("EMPLEADO_ID")
	  REFERENCES "SYSTEM"."EMPLOYEES" ("EMPLOYEE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMPLOYEES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."EMPLOYEES" ADD CONSTRAINT "FK_JOB" FOREIGN KEY ("JOB_ID")
	  REFERENCES "SYSTEM"."JOBS" ("JOB_ID") ENABLE;
  ALTER TABLE "SYSTEM"."EMPLOYEES" ADD CONSTRAINT "FK_DEPT" FOREIGN KEY ("DEPARTMENT_ID")
	  REFERENCES "SYSTEM"."DEPARTMENTS" ("DEPARTMENT_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table JOB_HISTORY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."JOB_HISTORY" ADD CONSTRAINT "FK_JH_EMPLOYEE" FOREIGN KEY ("EMPLOYEE_ID")
	  REFERENCES "SYSTEM"."EMPLOYEES" ("EMPLOYEE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."JOB_HISTORY" ADD CONSTRAINT "FK_JH_JOB" FOREIGN KEY ("JOB_ID")
	  REFERENCES "SYSTEM"."JOBS" ("JOB_ID") ENABLE;
  ALTER TABLE "SYSTEM"."JOB_HISTORY" ADD CONSTRAINT "FK_JH_DEPT" FOREIGN KEY ("DEPARTMENT_ID")
	  REFERENCES "SYSTEM"."DEPARTMENTS" ("DEPARTMENT_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LOCATIONS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LOCATIONS" ADD CONSTRAINT "FK_COUNTRY" FOREIGN KEY ("COUNTRY_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_ROLLUP" ADD CONSTRAINT "MVIEW$_ADV_ROLLUP_PFK" FOREIGN KEY ("RUNID#", "PLEVELID#")
	  REFERENCES "SYSTEM"."MVIEW$_ADV_LEVEL" ("RUNID#", "LEVELID#") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SP
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SP" ADD FOREIGN KEY ("S#")
	  REFERENCES "SYSTEM"."S" ("S#") ENABLE;
  ALTER TABLE "SYSTEM"."SP" ADD FOREIGN KEY ("P#")
	  REFERENCES "SYSTEM"."P" ("P#") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SPJ
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SPJ" ADD FOREIGN KEY ("S#")
	  REFERENCES "SYSTEM"."S" ("S#") ENABLE;
  ALTER TABLE "SYSTEM"."SPJ" ADD FOREIGN KEY ("P#")
	  REFERENCES "SYSTEM"."P" ("P#") ENABLE;
  ALTER TABLE "SYSTEM"."SPJ" ADD FOREIGN KEY ("J#")
	  REFERENCES "SYSTEM"."J" ("J#") ENABLE;
